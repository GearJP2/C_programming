...
struct AnswerPattern create_AnswerPattern(const char *name, const char *pattern) {
...
struct AnswerPattern create_AnswerPattern2(struct AnswerPattern* ap, const char *name, const char *pattern) {
    strcpy(ap->name, "Adrian");
    strcpy(ap->pattern, "C");
    ap->score = 0;
    ap->p_index = 0;
    ap->p_len = strlen(ap->pattern);
    return *ap;
}   
...
int main()
{
    ...
    struct AnswerPattern ap1 = create_AnswerPattern("Adrian", "C");
    ...
    int ap_arr_len = 3;
    struct AnswerPattern ap_arr[] = {
        create_AnswerPattern("XXX", "CA"),
        create_AnswerPattern("YYY", "C"),
        create_AnswerPattern("ZZZ", "C"),
    };
